...
(0, _ava2.default)('should return false for ignored message if defaults is false', t => {
	t.false((0, _2.default)('Auto-merged develop into master', {
		defaults: false
	}));
});

(0, _ava2.default)('should return false for ignored message if custom ignores and defaults is false', t => {
	t.false((0, _2.default)('Auto-merged develop into master', {
		defaults: false
	}));
});

(0, _ava2.default)('should throw error if ignores is not an array', t => {
	const ignoredString = 'this should be ignored';
	t.throws(() => {
		(0, _2.default)(ignoredString, {
			ignores: 'throws error'
		});
	});
});

(0, _ava2.default)('should return true for custom ignores as function', t => {
	const ignoredString = 'this should be ignored';
	t.true((0, _2.default)(ignoredString, {
