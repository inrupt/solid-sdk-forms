...
function getLanguageFromLiteral(subject, predicate, language) {
    var e_1, _a;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _b = __asyncValues(query_ldflex_1.default[subject][predicate]);
                    _d.label = 1;
...
exports.getLanguageFromLiteral = getLanguageFromLiteral;
//# sourceMappingURL=ldflex-helpers.js.map